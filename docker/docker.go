...
import (
	...
	"github.com/libcd/libcd/docker/internal"
...
func (e *dockerEngine) ContainerStart(container *libcd.Container) (string, error) {
...
func (e *dockerEngine) ContainerWait(id string) (*libcd.State, error) {
